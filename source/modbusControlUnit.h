...
#ifndef __driver_modbusControlUnit_h__
#define __driver_modbusControlUnit_h__
...
namespace driver {
	namespace modbus {
		...
		class modbusControlUnit : public chaos::cu::RTAbstractControlUnit {
			// init paramter
			string device_id;
		...
		public:
			 ...
			 */
			modbusControlUnit(string _device_id);
